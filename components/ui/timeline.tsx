...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
    ...
    // Using window scroll by removing target for testing.
    const { scrollYProgress } = useScroll({
        // target: containerRef, // commented out for now
        offset: ["start 10%", "end 50%"],
    });

    // Debug log to see scroll progress values.
    ...
    return (
        <div
            className="w-full bg-light-bg dark:bg-dark-bg font-sans md:px-10"
            ref={containerRef}
        >
